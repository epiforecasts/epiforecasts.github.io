...
In order to estimate this from the surveillance case data being published by countries around the world and collated by [@jhu](https://coronavirus.jhu.edu/data), we had to develop [methods](https://wellcomeopenresearch.org/articles/5-112) that account for reporting artefacts and delays whilst taking into account emerging insights on the epidemiology of SARS-CoV-2, especially incubation and generation times. [@seabbs](https://samabbott.co.uk/) led the development of our initial methodology (released in the EpiNow R package[@epinow]), and our updated approach (released in the EpiNow2 R package[@epinow2]) developed after discussions with colleagues on the limitations of our original implementation ([Gostic et al](https://doi.org/10.1371/journal.pcbi.1009679)). These packages ended up being the workhorses behind the web site and were used to provide daily updates of the estimates for almost all countries of the world, as well as several subnational geographies that we added over time.
