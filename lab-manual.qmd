...
The group’s github repository is <https://github.com/epiforecasts>. Initial and exploratory work should be in personal repositories; maturing and collaborative projects should be in the group repository. Any publication should be accompanied by a github repository with a README file that allows full reproducibility of the results, reviewed by at least one other team member. Code may either be licensed to the group or licensed to the authors and contributors of that work. We suggest the use of the MIT licence as a default. 


## Regular conferences

A collaborative database of conferences and funding opportunities can be found in this spreadsheet: [EpiForecasts opportunities](https://docs.google.com/spreadsheets/d/1JjWkQbkYlke_u2HJGEoktKhD8yX2tj4SQ43wDgE6qFg/edit#gid=0).
...
Following the main part of the meeting, we have a “something interesting I have found” part. where someone takes 5-10 minutes to present a paper, talk, blog post, R package, etc., and explain why they thought it was interesting.
