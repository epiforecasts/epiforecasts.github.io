...
Every project starts with a short analysis plan, shared with your supervisor and collaborators before diving into code. An analysis plan should cover:

1. **Research question** — one sentence.
2. **Background** — one paragraph, connecting to the broader context.
3. **Methods** — what data, what methods, what scenarios or comparisons.
4. **Results** — sketch the key figures, even if rough.
5. **Timeline** — rough milestones and when the project is "done".

The plan doesn't need to be long — one page is fine. It serves to sharpen the question and scope before investing weeks in code. Plans can be updated as the project evolves, but changes should be tracked and agreed with your supervisor — one purpose of the plan is to prevent scope creep.
